...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_SFTES, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_XXXXX, KC_XXXXX, KC_XXXXX, KC_GUIEI, LOWER, KC_SPC, KC_ENT, RAISE, KC_ALTKN, KC_XXXXX, KC_XXXXX, KC_XXXXX
),
