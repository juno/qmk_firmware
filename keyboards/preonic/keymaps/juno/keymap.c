 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  |GUIEI |Lower |Space |Enter |Raise |AltKan| Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  BACKLIT, KC_LCTL, KC_LALT, KC_TMB1, KC_TMB2, KC_TMB3, KC_TMB4, KC_TMB5, KC_TMB6, KC_DOWN, KC_UP,   KC_RGHT  \
),
